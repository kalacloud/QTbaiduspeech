...
const QString client_id = "hxISFtGKg0S5Ohue4bLG2RAV";
const QString client_secret = "hNEdpG7uoRV78QroTksGVThby3p7H7sE";

//语音识别相关
const QString baiduSpeechUrl = "http://vop.baidu.com/server_api?dev_pid=%1&cuid=******&token=%2";
